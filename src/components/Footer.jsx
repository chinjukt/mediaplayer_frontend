    ...
    <div style={{height:'300px'}} className='d-flex justify-content-center align-items-center w-100 flex-column'>
        <div className='d-flex justify-content-evenly align-items-center w-100'>
            <div className="websites" style={{width:'400px'}}>
                ...
                Video Player</h4>
                <h6>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus cupiditate soluta veniam, similique aperiam voluptatibus eum dolorum enim expedita voluptate illum? Illum natus nulla repudiandae provident, odit veniam pariatur magnam?</h6>
            </div>

            <div className="links d-flex flex-column mb-3">
                <h4>Links</h4>
            ...
            <div className="guides d-flex flex-column mb-3">
            <h4>Guides</h4>
